...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { building_id: @apartment.building_id, habitaciones: @apartment.habitaciones, m2: @apartment.m2, numero: @apartment.numero, piso: @apartment.piso } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { building_id: @apartment.building_id, habitaciones: @apartment.habitaciones, m2: @apartment.m2, numero: @apartment.numero, piso: @apartment.piso } }
